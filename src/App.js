...
export class App extends Component {
  ...
  buttonClick1 = (e) => {
    ...
    if (value === "15") {
      this.setState({
        durationImage: (
          <img className="state-image" src={Fifteen} alt="15"></img>
        ),
      });
    } else if (value === "30") {
      this.setState({
        durationImage: (
          <img className="state-image" src={Thirty} alt="30"></img>
        ),
      });
    } else if (value === "45") {
      this.setState({
        durationImage: (
          <img className="state-image" src={FortyFive} alt="45"></img>
        ),
      });
    }
    ...
    axios
      .get("https://ufitness.herokuapp.com/result")
  ...
  buttonClick2 = (e) => {
    ...
    if (value === "Strength") {
      this.setState({
        focusImage: (
          <img className="state-image" src={Strength} alt="strength"></img>
        ),
      });
    } else if (value === "Endurance") {
      this.setState({
        focusImage: (
          <img className="state-image" src={Endurance} alt="Endurance"></img>
        ),
      });
    } else if (value === "WeightLoss") {
      this.setState({
        focusImage: (
          <img className="state-image" src={Weight} alt="weight loss"></img>
        ),
      });
    }
  };
  ...
  buttonClick4 = (e) => {
    ...
    this.setState({
      todaysWorkout: this.state.todaysWorkout.filter(
        (workout) => workout.focus === this.state.focus
      ),
    });
  };
          ...
          <Switch>
            ...
            <Route
              ...
              render={(props) => (
                <Result
                  {...props}
                  todaysWorkout={this.state.todaysWorkout}
